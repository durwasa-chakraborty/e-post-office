...
<%@page import="com.epostoffice.BuyBean"  %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<table class="table table-striped table-hover ">
  ...
  <tbody>
    <tr>
      ...
      <td>INR <%BuyBean BbeanP = (BuyBean)request.getAttribute("Bbean");
      out.print(BbeanP.getInlandPostcards());%></td>
    </tr>
    <tr>
    	<td>2</td>
    	<td>Commemorative Postcards</td>
    	<td>INR <%
    	out.print(BbeanP.getCommemorativePostcards());%></td>
    </tr>
    <tr>
    	<td>3</td>
    	<td>International Postcards</td>
    	<td>INR <%
    	out.print(BbeanP.getInternationalPostcards());%></td>
    </tr>
    <tr>
    	<td>4</td>
    	<td>Picture Postcards</td>
    	<td>INR <%
    	out.print(BbeanP.getPicturePostcards());
    	%></td>
    </tr>
