  ...
  <tbody>
    <tr>
      ...
      <td>
    		...
    		<div class="input-group">
      		...
      		<input type="text" class="form-control" id="inlandPostcards" name="inlandPostcards" placeholder="Number">
    ...
    <tr>
      ...
      <td>
    		...
    		<div class="input-group">
      		<div class="input-group-addon">Quantity</div>
      		<input type="text" class="form-control" id="commemorativePostcards" name="commemorativePostcards" placeholder="Number">
    ...
    <tr>
      ...
      <td>
    		...
    		<div class="input-group">
      		<div class="input-group-addon">Quantity</div>
      		<input type="text" class="form-control" id="internationalPostcards" name="internationalPostcards" placeholder="Number">
    ...
    <tr >
      ...
      <td>
    		...
    		<div class="input-group">
      		<div class="input-group-addon">Quantity</div>
      		<input type="text" class="form-control" id="picturePostcards" name="picturePostcards" placeholder="Number">
